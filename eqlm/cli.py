...
def main() -> int:
    ...
    try:
        ...
        # Original eq command
        eq_sub = "eq"
        eq_parser = subparsers.add_parser(eq_sub, help="equalize image luminance (default, same as root command)")
        ...
        # Match command
        match_sub = "match"
        match_parser = subparsers.add_parser(match_sub, help="match histogram of source image to reference image")
