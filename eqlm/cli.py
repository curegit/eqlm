...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        # Original eq command
        eq_sub = "eq"
        eq_parser = subparsers.add_parser(eq_sub, aliases=["equalize"], allow_abbrev=False, formatter_class=ArgumentDefaultsHelpFormatter, description="equalize image luminance", help="equalize image luminance")
