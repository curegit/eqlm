...
def equalize(*, input_file: Path | str | bytes | Clipboard | None, output_file: Path | str | AutoUniquePath | BufferedIOBase | Clipboard | None, mode: Mode, vertical: int | None = None, horizontal: int | None = None, interpolation: Interpolation = Interpolation.Linear, target: float | None = None, clamp: bool = False, median: bool = False, unweighted: bool = False, gamma: float | None = None, deep: bool = False, slow: bool = False, orientation: bool = True) -> int:
    exit_code = 0
